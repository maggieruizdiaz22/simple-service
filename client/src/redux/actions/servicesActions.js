...
export const getServices = () => async (dispatch) => {
  try {
    const response = await axios.get(
      "https://simple-service-production.up.railway.app/services"
    );
...
export const getServiceDetail = (id) => async (dispatch) => {
  try {
    const response = await axios.get(
      `https://simple-service-production.up.railway.app/services/${id}`
    );
...
export const getServiceList = (id) => async (dispatch) => {
  try {
    const response = await axios.get(
      `https://simple-service-production.up.railway.app/${id}`
    );
...
export const getServicesByName = (name) => async (dispatch) => {
  try {
    const response = await axios.get(
      `https://simple-service-production.up.railway.app/services?servicename=${name}`
    );
...
export const cardsFilter = ({ order, direction, categoryId }) => async (
  ...
  try {
    if (order && direction && categoryId) {
      const response = await axios.get(
        `https://simple-service-production.up.railway.app/services?order=${order}&direction=${direction}&categoryId=${categoryId}`
      );
      return dispatch(filterServices(response.data));
    }
    if (order && direction) {
      const response = await axios.get(
        `https://simple-service-production.up.railway.app/services?order=${order}&direction=${direction}`
      );
      return dispatch(filterServices(response.data));
    }
    if (categoryId) {
      const response = await axios.get(
        `https://simple-service-production.up.railway.app/services?categoryId=${categoryId}`
      );
      return dispatch(filterServices(response.data));
    }
  } catch (error) {
